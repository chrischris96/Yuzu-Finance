  ...
  return (
    <main className="workspace">
      ...
      <section className="intro">
        <div>
          <p className="eyebrow">METHODOLOGY · VERSION 0.2</p>
      ...
      <section className="panel">
        ...
        <p>
          ...
          opening consideration, monthly contractual coupons and principal
          redemption at the selected maturity. Interest accrues monthly; coupons
          are paid monthly; principal is redeemed at maturity. There are no
        ...
        <p>
          Fair values are supplied as opening and 12-month endpoints.
          Intermediate values use a straight-line illustrative path, not a
          pricing model or historical market data. Derivatives must mature
          beyond the horizon: settlement, interim swap payments, collateral,
          netting, foreign-currency translation and hedge accounting are not
          modelled. Fair value changes go to profit or loss, or to OCI for
          eligible FVOCI debt.
        </p>
        ...
        <p>
          Generated postings are cumulative snapshots, with aggregated interest
          and coupons. Manual and CSV adjustments must balance on each date and
        ...
        <p>
          ...
          page shows hypothetical IFRS 9 debt measurement categories, not
          permissible reclassification elections.
        </p>
        <h2>Your data</h2>
        <p>
